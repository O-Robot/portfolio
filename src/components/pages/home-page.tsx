...
import { primaryTechnologies } from "@/utils/profile";
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            {/* <motion.p
              ...
              className="text-xl md:text-2xl text-primary-text mb-4 font-light"
            >
              {robot.tagline}
            </motion.p> */}
            ...
            <motion.p
              ...
              className="mx-auto mb-4 max-w-3xl text-base md:text-base text-primary-text/80 leading-relaxed"
            >
              I build fast, reliable software with {stackPreview}, helping teams
              ship polished web and mobile experiences that solve real problems.
            </motion.p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-primary-text/80 max-w-3xl mx-auto">
              Roles across enterprise platforms, media products, logistics
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-secondary-text max-w-3xl mx-auto">
              Hiring for a frontend role, planning a web or mobile product, or
              looking for a thoughtful engineering collaborator? Let&apos;s
              talk.
            </p>
          </motion.div>
            ...
            >
              ...
              <Card className="glass-morphism border-white/20">
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm leading-relaxed text-primary-text/70">
                    Explore my experience, review selected projects, or start a
                    conversation about roles, collaborations, and product work.
                  </p>
                  <Button
                    type="submit"
