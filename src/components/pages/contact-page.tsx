        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-primary-text/80 max-w-3xl mx-auto">
              Hiring for a frontend role, planning a product, or looking for a
              collaborator for web or mobile work? I&apos;m open to thoughtful
              conversations.
            </p>
          </motion.div>
              ...
              <Card className="glass-morphism border-white/20">
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm leading-relaxed text-primary-text/70">
                    Reach out for product builds, frontend hiring conversations,
                    freelance work, or collaborations that need a thoughtful
                    engineer.
                  </p>
